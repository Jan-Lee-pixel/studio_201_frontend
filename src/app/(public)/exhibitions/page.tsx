...
export default function ExhibitionsPage() {
  ...
  return (
    <div className="w-full pt-32 pb-20 px-6 md:px-12">
      <Reveal><SectionLabel>All Exhibitions</SectionLabel></Reveal>
      <Reveal><h1 className="font-display text-[clamp(40px,6vw,72px)] font-normal leading-tight mb-16 tracking-[-0.02em]">Curated<br />Exhibitions</h1></Reveal>
