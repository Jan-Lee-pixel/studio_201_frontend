              ...
              {pending.map(sub => (
                <div key={sub.id} className="border border-[var(--color-rule)] bg-[var(--color-bone)] overflow-hidden flex flex-col group hover:border-[var(--color-sienna)] transition-colors">
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <div className="text-xs font-mono text-gray-400 mb-4 tracking-wider uppercase">Artist ID: {sub.artistId.substring(0,8)}...</div>
              ...
              <table className="w-full text-left font-body text-sm">
                <thead>
                  <tr className="border-b border-gray-200 text-gray-400 font-mono text-xs uppercase tracking-widest">
                    ...
                    <th className="pb-3 px-4 font-normal">Date Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {reviewed.length === 0 ? (
                    <tr><td colSpan={3} className="py-6 text-center text-gray-400 italic">No reviewed submissions.</td></tr>
                  ) : (
                    reviewed.map(sub => (
